...
st.text(""" 
        The chatbot processes your query by running a backend code engine that extracts and transforms the data to focus on the most relevant columns and fields.
        A specialized model then summarizes the transformed data into a concise and comprehensive format.
        The final summary is displayed here in the interface for your review.
        Please note that this process may take up to 5 minutes, as it involves several detailed steps. Thank you for your patience!
        """)
