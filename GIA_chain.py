...
summary_messages = [
    ("system", "You have been provided with audit reports that contain various attributes. "
     "The user may ask you to generate a detailed summary of an issue, including all sub-sections as requested. If there are multiple issues with the same name, include them all in the summary."
...
general_messages = [
    MessagesPlaceholder(variable_name="history"),  # Include chat history
    ("system", "You are an analytical assistant who has been given list of issues. When a user gives a query, provide a precise answer to the query. Give the most importance to precision."
     "If the user's question has an issue title, check only that issue and no other issues"
